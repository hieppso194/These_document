...
- An approach to transform raw data from kniect to motion file format which can be processed by 3D animation software
(Reference)[https://ieeexplore.ieee.org/stamp/stamp.jsp?arnumber=7334929]
